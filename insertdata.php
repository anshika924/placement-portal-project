...
if(isset($_POST["submit"]))
{
    if($_FILES['file']['name'])
    {
        ...
        if($filename[1] == 'csv')
        {
            ...
            fclose($handle);
            if($count > 0) {
                $error_msg = "$count records were skipped (duplicate Regd No).";
            }
            if($inserted > 0) {
                $success_msg = "$inserted records successfully inserted.";
            }
        } else {
...
<head>  
    ...
    <title>Insert Data | Staff Portal</title>
...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar">
            ...
            <ul class="nav-links">
                ...
                <li class="nav-item active"><a href="insertdata.php"><i class="fas fa-plus-circle"></i> Insert New Student</a></li>
        ...
        <main class="main-content">
            <header class="header animate-up">
                <div>
                    <h1 style="font-family: var(--font-heading); font-size: 24px; font-weight: 600;">Data Import Center</h1>
                    <p style="color: var(--text-secondary); margin-top: 4px;">Upload academic records into the centralized placement database.</p>
                </div>
            </header>
            ...
            <div class="data-panel animate-up" style="max-width: 800px; margin: 0 auto;">
                ...
                <form method="post" enctype="multipart/form-data">
                    <label class="upload-area" for="file-input">
                        ...
                        <p style="font-weight: 700; color: var(--text-primary); margin-bottom: 4px;">Choose CSV File</p>
                        <p style="font-size: 12px; color: var(--text-secondary);">Drag and drop your file here or click to browse</p>
                ...
                <div class="guide-box">
                    ...
                    <ul>
                        ...
                        <li><strong>Column 1:</strong> Registration Number (e.g., 21CSE101)</li>
                        <li><strong>Column 2:</strong> CGPA (e.g., 8.5)</li>
                        <li><strong>Column 3:</strong> Number of Backlogs (e.g., 0)</li>
                        <li>Duplicate Registration Numbers will be skipped automatically.</li>
                    </ul>
                </div>
            </div>
        </main>
    ...
    <script>
        document.getElementById('file-input').onchange = function() {
            document.getElementById('file-name').innerHTML = "<i class='fas fa-file-csv'></i> Selected: " + this.files[0].name;
        };
    </script>
